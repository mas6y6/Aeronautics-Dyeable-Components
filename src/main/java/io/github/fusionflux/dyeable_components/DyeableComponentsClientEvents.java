...
@EventBusSubscriber(modid = DyeableComponents.ID, value = Dist.CLIENT)
public class DyeableComponentsClientEvents {
    @SubscribeEvent
    ...
    public static class ModBusEvents {
        ...
        public static void clientSetup(FMLClientSetupEvent event) {
            ...
            for (DyeColor color : DyeColor.values()) {
                setRenderTypes(DyeableComponentsBlocks.DYED_LEVITITE_BLOCKS.get(color).get(), set);
            }
        }
