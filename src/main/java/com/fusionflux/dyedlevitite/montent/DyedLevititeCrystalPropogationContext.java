...
public class DyedLevititeCrystalPropogationContext implements CrystalPropagationContext {
    ...
    private final DeferredBlock<Block> dyedLevitite;

    public DyedLevititeCrystalPropogationContext(DeferredBlock<Block> dyedLevitite) {
        this.dyedLevitite = dyedLevitite;
    }
    ...
    public BlockState getCrystalBlockState(Level level, BlockPos pos) {
        return dyedLevitite.value().defaultBlockState();
    }
